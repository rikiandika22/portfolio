...
interface AboutDetailContactCTAProps {
 ...
 * - Supports separate contentRef for decoupled background panel entrance and inner typography fade/settle.
 * - Supports transparentBg prop for unified single-background mask ownership during scroll transitions.
 ...
 */
const AboutDetailContactCTA = forwardRef<HTMLDivElement, AboutDetailContactCTAProps>(
  ({ contentRef, transparentBg = false }, ref) => {
    const scrollToTop = () => {
      window.scrollTo({
        top: 0,
        behavior: "smooth",
    ...
    return (
      <section
        ref={ref}
        className="w-full text-white min-h-screen lg:min-h-full flex flex-col items-center justify-center relative box-border"
        style={{
      ...
      >
        <div
          ref={contentRef}
          data-cta-inner-content
          className="mx-auto w-full max-w-[1380px] flex flex-col items-center justify-center py-20 lg:py-24 box-border text-center will-change-[opacity,transform]"
...
AboutDetailContactCTA.displayName = "AboutDetailContactCTA";

export default AboutDetailContactCTA;
