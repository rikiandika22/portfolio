...
import type { MoneyLogTechnologySlideData } from "@/data/moneyLogSlides";
import { MONEYLOG_ALL_TECH_ICONS } from "@/data/moneyLogSlides";
...
interface MoneyLogTechnologyProps {
  data: MoneyLogTechnologySlideData;
}

/**
 * Slide 02 — MoneyLog The Technology Behind the System.
 * Uses identical typography system, headline scale, and interactive accordion
 * components as Sumber Agung Trans.
 */
export default function MoneyLogTechnology({ data }: MoneyLogTechnologyProps) {
      ...
      <div className="grid grid-cols-1 content-start gap-x-12 gap-y-4 lg:gap-y-0 lg:grid-cols-12 xl:gap-x-16 w-full">
        ...
        >
          <TechStackAccordion
            ...
            allIcons={MONEYLOG_ALL_TECH_ICONS}
